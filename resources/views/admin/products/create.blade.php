        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response['status'] == true) {
                    ...
                    $("#compare_price").removeClass('is-invalid')
                        .siblings('p')
                        .removeClass('invalid-feedback').html("");
                    ...
                    //     $('#compare_price').addClass('is-invalid').siblings('p').addClass('invalid-feedback').html(errors['compare_price']);
                    // } else {
                    //     $('#compare_price').removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').html("")
                    // }
                    ...
                    //     $('#sub_category_id').addClass('is-invalid').siblings('p').addClass('invalid-feedback').html(errors['sub_category_id']);
                    // } else {
                    //     $('#sub_category_id').removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').html("")
                    // }

                    // if (errors['brand_id']) {
                    //     $('#brand_id').addClass('is-invalid').siblings('p').addClass('invalid-feedback').html(errors['brand_id']);
                    // } else {
                    //     $('#brand_id').removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').html("")
                    // }
